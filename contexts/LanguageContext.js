...
messageVerified: 'Message Verified',
  ...
  hindi: {
    ...
    signupDescription: 'करपया अपनी प्रोफाइल पूरी करें। चिंता न करें, आपका डेटा निजी रहेगा और केवल आप ही इसे देख सकते हैं।',
    ...
    // EMI Manager Screen
    calculateEMI: 'ईएमआई कैलकुलेट करें',
    ...
    // SIP Tracker Screen
    calculateSIP: 'SIP रिटर्न कैलकुलेट करें',
    ...
    sipDisclaimer: 'नोट: यह कैलकुलेटर एक अनुमान प्रदान करता है। वास्तविक रिटर्न बाजार की स्थितियों और फंड प्रदर्शन के आधार पर भिन्न हो सकते हैं।',
    ...
    addTransactionFailed: 'लेनदेन जोड़ने में विफल रहा',
    ...
    confirmDeleteMessage: 'क्या आप वाकई इस श्रेणी को हटाना चाहते हैं? यह कार्रवाई पूर्ववत नहीं की जा सकती।',
    delete: 'हटाएं',
    deleteCategoryFailed: 'श्रेणी हटाने में विफल रहा',
