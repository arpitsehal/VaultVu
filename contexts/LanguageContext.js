...
const translationsData = {
  ...
  hindi: {
    ...
    newOnboardingAlreadyAccountButton: 'मेरा पहले से ही एक खाता है',
    ...
    googleSignInTitle: 'गूगल साइन-इन',
    googleSignInMessage: 'गूगल साइन-इन प्रक्रिया शुरू की जा रही है...',

    // Create Account Page 1
    createAccountHeader: 'एक',
    accountHighlight: 'खाता बनाएं',
    signupDescription: "कृपया अपनी प्रोफाइल पूरी करें। चिंता न करें, आपका डेटा निजी रहेगा और केवल आप ही इसे देख सकते हैं।",
    ...
    passwordValidationError: 'पासवर्ड में होना चाहिए:',
    ...
    passwordRule_number: 'कम से कम एक संख्या',
    passwordRule_specialChar: 'कम से कम एक विशेष अक्षर (!@#$%^&*)',
    ...
    // Create Account Page 2
    signup2Header: 'एक',
    signup2Description: 'कृपया अपना यूजरनेम, जन्मतिथि, देश और लिंग दर्ज करें।',
  ...
  punjabi: {
    ...
    // Onboarding Screen 2
    newOnboardingDescription: 'VaultVu ਤੁਹਾਨੂੰ ਇੰਟਰੈਕਟਿਵ ਪਾਠਾਂ ਅਤੇ ਸਮਾਰਟ ਟੂਲਜ਼ ਨਾਲ ਵਿੱਤੀ ਸਾਖਰਤਾ ਵਿੱਚ ਮੁਹਾਰਤ ਹਾਸਲ ਕਰਨ ਅਤੇ ਧੋਖਾਧੜੀ ਤੋਂ ਆਪਣੇ ਆਪ ਨੂੰ ਬਚਾਉਣ ਵਿੱਚ ਮਦਦ ਕਰਦਾ ਹੈ। ਆਪਣੇ ਵਿੱਤੀ ਭਵਿੱਖ ਨੂੰ ਸੁਰੱਖਿਅਤ ਕਰੋ।',
    ...
    female: 'ਔਰਤ',
    other: 'ਹੋਰ',
    preferNotToSay: 'ਦੱਸਣਾ ਪਸੰਦ ਨਹੀਂ ਕਰਦਾ',
