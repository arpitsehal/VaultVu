...
export default function BlackmailScamScreen() {
  ...
  const scamDetails = {
    title: 'Debt settlement and debt relief scams',
    description: 'Debt settlement or debt relief companies often promise to renegotiate, settle, or in some way change the terms of a debt you owe to a creditor or debt collector. Dealing with debt settlement companies, though, can be risky and could leave you even further in debt.',
    whatToDo: [
      ...
      'Beware Pressure Tactics: Don’t rush—take time to compare options or seek advice.',
