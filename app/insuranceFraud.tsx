...
export default function InsuranceFraudScreen() {
  ...
  const title = (translations as any).insuranceFraudTitle || 'Insurance Fraud';
  const description =
    (translations as any).insuranceFraudDescription ||
  ...
  const whatToDoTitle = (translations as any).insuranceFraudWhatToDoTitle || "What to do if you're targeted:";
  const tips = [
    (translations as any).insuranceFraudTip1 || 'Verify the credentials of insurance agents and companies with IRDAI or RBI.',
    (translations as any).insuranceFraudTip2 || 'Do not make payments in cash or to personal accounts of agents.',
    (translations as any).insuranceFraudTip3 || 'Read policy documents carefully and keep all receipts.',
    (translations as any).insuranceFraudTip4 || 'Report suspicious insurance offers to your insurer and authorities.',
    (translations as any).insuranceFraudTip5 ||
