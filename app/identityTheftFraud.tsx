...
export default function IdentityTheftFraudScreen() {
  ...
  const title = (translations as any).identityTheftTitle || 'Identity Theft';
  const description =
    (translations as any).identityTheftDescription ||
  ...
  const whatToDoTitle = (translations as any).identityTheftWhatToDoTitle || "What to do if you're targeted:";
  const tips = [
    (translations as any).identityTheftTip1 || 'Keep your personal documents and information secure and do not share them unnecessarily.',
    (translations as any).identityTheftTip2 || 'Monitor your bank statements and credit reports regularly.',
    (translations as any).identityTheftTip3 || 'Report lost or stolen documents to authorities and your bank immediately.',
    (translations as any).identityTheftTip4 || 'Be cautious of sharing personal details online or over the phone.',
    (translations as any).identityTheftTip5 ||
